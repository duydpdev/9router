...
| 🗄️ **Opt-In Embeddings Cache** ([docs](./docs/integrations/prompt-cache.md)) | `x-router-cache: ttl=<s>` header → replay identical embeddings from memory | Skip repeat upstream calls in test/index loops |
